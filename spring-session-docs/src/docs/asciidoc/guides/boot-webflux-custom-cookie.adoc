...
<1> We customize the name of the cookie to be `CSESSION`.
...
If you look at the cookies for the application, you can see the cookie is saved to the custom name of `CSESSION`.
